...
module.exports.updProd = function (req, res) {
    ...
    Product.findById(id, (err, product) => {
        if (err) {
            ...
            product.additionalImagePaths = req.body.additionalImagePaths.split(',').map(path => path.trim());
...
module.exports.create = function (req, res) {
    Product.create({
        ...
        additionalImagePaths: req.body.additionalImagePaths.split(',').map(path => path.trim()),
